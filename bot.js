...
**
      `,`
        ***__أوامر اضافية__***
**
Jping - حتى تشوف بنق البوت
Juptime - حتى تشوف البوت من كم شغال
 ...
 client.on('message', function(message) {
  ...
  client.on('message',async message => {
    if(message.content.startsWith(adminprefix + "restart")) {
        if(message.author.id !== "478811937053081601") return message.reply('You aren\'t the bot owner.');
